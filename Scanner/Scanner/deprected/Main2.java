...
private JPanel createBottomPanel() {
    ...
    private void createMenuBar() {
        ...
        tokenizeMenuItem.addActionListener(e -> {
            ArrayList<String> errors = tokenizeCode();
            if (!errors.isEmpty()) {
    ...
    private void showSyntaxErrors(ArrayList<String> errors) {
        ...
        errorMessage.append("Syntax Errors Found:\n\n");
    ...
    private ArrayList<String> tokenizeCode() {
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            if (!processedLine.endsWith(";") && 
                ...
                !processedLine.startsWith("{")) {
                errors.add("Line " + (i+1) + ": Missing semicolon or invalid statement");
            }
